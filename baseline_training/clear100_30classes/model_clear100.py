"""
model_clear100.py - PyTorch Lightning Module for CLEAR-100 Multi-Class Classification

This module handles the model architecture, training, and evaluation for CLEAR-100 dataset.
Supports both transformer models (HuggingFace) and CNN models (torchvision).

Dataset: CLEAR-100 (30-class subset)
Classes: airplane, aquarium, baseball, beer, billiard, boat, bowling_ball, bridge,
...
def get_model_info(model_key: str) -> Dict[str, Any]:
    ...
    warnings.warn(
        ...
        f"To use a custom model, add it to MODEL_REGISTRY in model_clear100.py\n"
...
def load_torchvision_model(model_id: str, num_classes: int, dropout_rate: float = 0.2) -> nn.Module:
    ...
    if model_id == 'resnet50':
    ...
    elif model_id == 'vgg16_bn':
        weights = tv_models.VGG16_BN_Weights.IMAGENET1K_V1
        ...
        weights = tv_models.ResNet101_Weights.IMAGENET1K_V2
...
class CLEAR100Classifier(pl.LightningModule):
    """
    PyTorch Lightning Module for 30-class classification on CLEAR-100 dataset.
    
    Supports both HuggingFace transformers and torchvision CNN architectures.
    
    Args:
        model_name: Model key from MODEL_REGISTRY
        num_classes: Number of classes (default: 30 for CLEAR-100)
    ...
    def __init__(
        ...
        # Store class names (30 classes for CLEAR-100)
        ...
        # Define metrics for multiclass classification (30 classes)
