"""
Training script for CLEAR-100 multi-class classification (30 classes).

Usage:
    python train_clear100.py --year_name year_1-2
    python train_clear100.py --year_name year_5 --max_epochs 15 --batch_size 64
...
from data_module_clear100 import CLEAR100DataModule, auto_detect_num_workers
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Train CLEAR-100 classifier",
...
def main():
    ...
    print("CLEAR-100 TRAINING (30 classes)")
