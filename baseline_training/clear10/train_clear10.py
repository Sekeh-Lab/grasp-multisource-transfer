"""
train_clear10.py - Training script for CLEAR-10 multi-class classification

This script trains a model on a single year of the CLEAR-10 dataset (10-class classification).
...
from data_module_clear10 import CLEAR10DataModule
...
# Import helper functions from yearbook training script
# (You'll need to copy these functions or import them)
...
def train(args):
    ...
    print("=" * 80)
    print("CLEAR-10 MULTI-CLASS CLASSIFICATION TRAINING")
...
def main():
    parser = argparse.ArgumentParser(
        description="Train MobileViT on CLEAR-10 dataset for multi-class classification",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    
    # Data arguments
    parser.add_argument("--data_root", type=str, default="../../datasets/CLEAR10",
                       help="Root directory of CLEAR10 dataset")
    ...
    # Logging
    parser.add_argument("--log_dir", type=str, default="../../../results/clear10/logs")
    parser.add_argument("--checkpoint_dir", type=str, default="../../../results/clear10/model_checkpoints")
