#!/usr/bin/env python
"""
run_all_fusion_clear100.py - Run all FUSION experiments for CLEAR-100

Runs comprehensive FUSION experiments across CLEAR-100 temporal bins (30 classes).

Usage:
    python run_all_fusion_clear100.py --trial 3
    python run_all_fusion_clear100.py --model resnet-50 --trial 3
"""
...
def write_summary_report(all_results: Dict, summary_file: Path, args):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 100 + "\n")
        f.write("FUSION - CLEAR-100 COMPREHENSIVE RESULTS\n")
        f.write("=" * 100 + "\n\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run all FUSION experiments for CLEAR-100",
    ...
    print(f"\n{'='*100}")
    print(f"FUSION COMPREHENSIVE EXPERIMENTS - CLEAR-100")
    print(f"{'='*100}")
    ...
    if all_results:
        summary_file = Path(f"fusion_{args.model}_clear100_summary.txt")
