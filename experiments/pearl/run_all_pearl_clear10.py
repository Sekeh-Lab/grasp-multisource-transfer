#!/usr/bin/env python
"""
run_all_pearl_clear10.py - Run all PEARL experiments for CLEAR-10

Runs comprehensive PEARL experiments across all CLEAR-10 temporal bins.

Usage:
    python run_all_pearl_clear10.py --num_trials 3 --model mobilevit-xxs
    python run_all_pearl_clear10.py --num_trials 5 --model mobilevit-small
"""
...
def write_summary_report(all_results: Dict, summary_file: Path, args):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 100 + "\n")
        f.write("PEARL - CLEAR-10 COMPREHENSIVE RESULTS\n")
        f.write("=" * 100 + "\n\n")
        
        f.write("CONFIGURATION\n")
        f.write("-" * 100 + "\n")
        f.write(f"Dataset:           CLEAR-10 (11-class classification)\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run all PEARL experiments for CLEAR-10"
    )
    ...
    print(f"\n{'='*100}")
    print(f"PEARL COMPREHENSIVE EXPERIMENTS - CLEAR-10")
    print(f"{'='*100}")
    ...
    if all_results:
        summary_file = Path(f"pearl_{args.model}_clear10_summary.txt")
