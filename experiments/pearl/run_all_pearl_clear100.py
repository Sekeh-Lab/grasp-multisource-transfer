#!/usr/bin/env python
"""
run_all_pearl_clear1000.py - Run all PEARL experiments for CLEAR-100

Runs comprehensive PEARL experiments across all CLEAR-100 temporal bins.

Usage:
    python run_all_pearl_clear1000.py --num_trials 3 --model mobilevit-xxs
    python run_all_pearl_clear1000.py --num_trials 5 --model mobilevit-small
"""
...
def write_summary_report(all_results: Dict, summary_file: Path, args):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 100 + "\n")
        f.write("PEARL - CLEAR-100 COMPREHENSIVE RESULTS\n")
        f.write("=" * 100 + "\n\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run all PEARL experiments for CLEAR-100"
    )
    ...
    print(f"\n{'='*100}")
    print(f"PEARL COMPREHENSIVE EXPERIMENTS - CLEAR-100")
    print(f"{'='*100}")
    ...
    if all_results:
        summary_file = Path(f"pearl_{args.model}_clear100_summary.txt")
