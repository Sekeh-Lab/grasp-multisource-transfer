#!/usr/bin/env python
"""
run_all_ensemble_clear10.py - Run all ENSEMBLE experiments for CLEAR-10

Runs comprehensive ENSEMBLE experiments across CLEAR-10 time periods.
...
def write_summary_report(all_results: Dict, summary_file: Path, args):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 100 + "\n")
        f.write("ENSEMBLE - CLEAR-10 COMPREHENSIVE RESULTS\n")
        f.write("=" * 100 + "\n\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run all ENSEMBLE experiments for CLEAR-10",
    ...
    print(f"\n{'='*100}")
    print(f"ENSEMBLE COMPREHENSIVE EXPERIMENTS - CLEAR-10")
    print(f"{'='*100}")
    ...
    if all_results:
        summary_file = Path(f"ensemble_{args.model}_clear10_summary.txt")
